...
<tr align="left">
    ...
    <p style="font-family: 'Abhaya Libre'; width:90%; color:navy; font-size: 20px;" class="style2"><i class="fa fa-user icon"style="font-size: 20px;"></i>  WELCOME ADMIN </p></th>  
  </tr>
</table>
...
<div class="box-1">
          ...
          <a href="a_result.php" style="color:rgb(87, 22, 22)">  
                <div class="btn btn-one btn-a">
                    <span > Election Result</span>
               </div>
          </a>
          <a href="a_winner.php" style="color:rgb(87, 22, 22)">  
                <div class="btn btn-one">
                    <span>Winners </span>
               </div>
          </a>
...
<h2 align="left" style="margin-left:720px;font-family: 'Playfair Display', serif;font-size:40px">Results</h2>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <div class="container"  align="center">
    ...
    <tr>
     ...
     <br>
     <button style="width: 40%; margin-left:25px;border-radius:15px;" type="submit" name="Submit" value="Submit">Submit</button><br>
</div>
</form>
<hr align ="centre" style="width:70%;" noshade="5.5">
...
<div>
      ...
      <tr style="font-family: 'Playfair Display', serif;text-align:center">
            ...
            <th style="width:700px">Seat Name  </th>
              ...
              <th style="width:700px">Party Name</th>
